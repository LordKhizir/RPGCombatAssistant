...
public enum ArmorType {
	...
	TP2(  2,  1, R.string.armor_merp_1,  R.string.armor_rm_2),
	TP3(  3,  1, R.string.armor_merp_1,  R.string.armor_rm_3),
	TP4(  4,  1, R.string.armor_merp_1,  R.string.armor_rm_4),
	TP5(  5,  5, R.string.armor_merp_5,  R.string.armor_rm_5),
	TP6(  6,  5, R.string.armor_merp_5,  R.string.armor_rm_6),
	TP7(  7,  5, R.string.armor_merp_5,  R.string.armor_rm_7),
	TP8(  8,  5, R.string.armor_merp_5,  R.string.armor_rm_8),
	TP9(  9, 10, R.string.armor_merp_10, R.string.armor_rm_9),
	TP10(10, 10, R.string.armor_merp_10, R.string.armor_rm_10),
	TP11(11, 10, R.string.armor_merp_10, R.string.armor_rm_11),
	TP12(12, 10, R.string.armor_merp_10, R.string.armor_rm_12),
	TP13(13, 15, R.string.armor_merp_15, R.string.armor_rm_13),
	TP14(14, 15, R.string.armor_merp_15, R.string.armor_rm_14),
	TP15(15, 15, R.string.armor_merp_15, R.string.armor_rm_15),
	TP16(16, 15, R.string.armor_merp_15, R.string.armor_rm_16),
	TP17(17, 20, R.string.armor_merp_20, R.string.armor_rm_17),
	TP18(18, 20, R.string.armor_merp_20, R.string.armor_rm_18),
	TP19(19, 20, R.string.armor_merp_20, R.string.armor_rm_19),
